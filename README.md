...
- A Chinese [new-robot retargeting integration and acceptance guide](docs/new_robot_retargeting_guide_zh.md), covering model audits, semantic mappings, frame calibration, staged IK, tuning order, and quantitative validation.
...
- **2026-08-13:** Generalized `mobile_upper_body` into a wheeled dual-arm protocol with optional head and wrist-orientation tasks, and migrated **Galaxea R1 Pro** to semantic retargeting. The obsolete left-foot/hip/knee mappings to its mobile mechanism were removed. See the Chinese [`docs/galaxea_r1pro_retargeting.md`](docs/galaxea_r1pro_retargeting.md).
- **2026-08-13:** Added a Chinese [new-robot retargeting integration and acceptance guide](docs/new_robot_retargeting_guide_zh.md), distilling the reusable lessons from the Galbot integration: map motion intent to robot capabilities, then validate the model, static poses, motion sequences, metrics, and side-by-side visuals.
- **2026-08-12:** Added tuned SMPL-X retargeting for the wheeled dual-arm **Galbot One Golf** (`galbot_one_golf`). The planar base follows G1 root-motion semantics, the five-axis lift/waist follows a bounded upper-body target, arm targets preserve human upper-arm and forearm directions, and revolute joints retain a 2-degree limit margin. See [`docs/galbot_one_golf_retargeting.md`](docs/galbot_one_golf_retargeting.md).
...
| 11                        | Galaxea R1 Pro `galaxea_r1pro` (wheeled dual-arm)                     | Planar base (3) + steering/wheels (6) + torso (4) + arms (2*7) = 27 | ✅                                                                                  | TBD                                                                        | TBD                                           | TBD                                 |
| 21                        | Galbot One Golf `galbot_one_golf` (wheeled dual-arm)                  | Base (3) + Lift/Waist (5) + Arms (2*7) + Head (2) = 24 | ✅                                                                                                 | TBD                                                                        | TBD                                           | TBD                                 |
